...
namespace Watchlist.Data.Migrations
{
    ...
    [Migration("20221021180917_UserNameAndUserEmailSetAsRequired")]
    partial class UserNameAndUserEmailSetAsRequired
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Watchlist.Models.UserMovie", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Watchlist.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Watchlist.Models.Movie", b =>
                {
                    b.HasOne("Watchlist.Models.Genre", "Genre")
                        .WithMany()
